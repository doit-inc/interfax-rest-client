 ...
 * [サンプルコード] FAX送信のキャンセル.
 * 
 * Id を指定して、リクエスト済みのFAX送信をキャンセルします。
 * 
 ...
 */
public class ExecSendFaxCancelFax {
    ...
    public static void main(String[] args) {
        try {
            ...
            MethodResponse response = send.cancelFax(0); // <- 適切な Transaction Id を指定します
            //
            ...
            Logger.getLogger(ExecSendFaxCancelFax.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
