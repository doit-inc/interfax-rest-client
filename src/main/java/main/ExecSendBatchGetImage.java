...
/**
 * [サンプルコード] 複数宛先に対する一括 FAX送信(BATCH)のFAXイメージ取得.
 * 
 * Id を指定して、特定のBATCH 送信のFAXイメージを取得します。
 * 
 ...
 */
public class ExecSendBatchGetImage {
    ...
    public static void main(String[] args) {
        try {
            ...
            MethodResponse response = send.getBatchImage(0, os); // <- 適切な Transaction Id を指定します
            ...
            Logger.getLogger(ExecSendBatchGetImage.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
