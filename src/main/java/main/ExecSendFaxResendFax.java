...
/**
 * [サンプルコード] 完了済み FAX送信の再送.
 * 
 * TransactioId を指定して、特定のFAX送信を再送します。
 * 
 ...
 */
public class ExecSendFaxResendFax {
    ...
    public static void main(String[] args) {
        try {
            ...
            SendFaxResponse response = send.resendFax(0, null); // <- 適切な Transaction Id を指定します
            //
            ...
            Logger.getLogger(ExecSendFaxResendFax.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
