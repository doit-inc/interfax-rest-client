 ...
 */
public class ExecSendFaxWithSingleDocument {
        ...
        try {
            do {
                ...
                StreamContent stream = new StreamContent(content, () -> {
                    return(ExecSendFaxWithSingleDocument.class.getResourceAsStream(content));
                }, null);
            ...
            Logger.getLogger(ExecSendFaxWithSingleDocument.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
